      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
            {/* Contact Form */}
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-elegant animate-fade-up">
            ...
            <div className="space-y-8 animate-fade-up" style={{ animationDelay: "0.1s" }}>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-sm hover:shadow-gold transition-all">
              ...
              <div className="p-8 bg-gradient-to-br from-zenith to-accent rounded-xl text-white">
